...
description: 'Review an Azure DevOps pull request (dev.azure.com / visualstudio.com) end to end from the command line, posting findings as inline PR comments. Triggers: an Azure DevOps PR URL or id to review; `az repos` auth or the diffs API misbehaves.'
license: MIT
metadata:
