---
name: restomod
description: 'Revives a dormant codebase without breaking its consumers: review, correctness fixes and modernization behind green CI. Use to revive an old library.'
license: MIT
metadata:
