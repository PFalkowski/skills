---
name: model-bake-off
description: 'Picks the best-value model tier for a class of task with a rubric-first, blind-scored, dollar-ranked bake-off. Use for "which model is best for this".'
license: MIT
metadata:
