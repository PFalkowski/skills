---
name: prompt-backlog
description: 'Captures deferred work as an ordered backlog of ready-to-run prompts a fresh agent can run verbatim, tagged with why it was asked. Use whenever work is deferred: "do this next", "later", "remind me to", "add to the backlog", "queue this up", "we should do X at some point", "follow-up", or /prompt-backlog.'
license: MIT
metadata:
