...
- [ci-hardcodes-the-clean-room-test-path](ci-hardcodes-the-clean-room-test-path.md) — moving `archive/clean-room/` breaks CI, because `checks.yml` names that test file literally
