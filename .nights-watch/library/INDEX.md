...
- [repo-ci-check-surface](repo-ci-check-surface.md) — what CI actually runs, and which of those checks can fail a build (`check-descriptions.sh` fails on length/quoting/self-naming, only warns in the 161-200 char band)
