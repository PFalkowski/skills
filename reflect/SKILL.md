---
name: reflect
description: 'Lists the assumptions a task rests on and routes each to look up, verify, default or ask. Use before starting, or for "what are you assuming" or "sanity check".'
license: MIT
metadata:
...
This is inversion — ask what would guarantee failure rather than what would produce success
([`invert`](../invert/SKILL.md)). Two prompts reliably surface the missed ones:
